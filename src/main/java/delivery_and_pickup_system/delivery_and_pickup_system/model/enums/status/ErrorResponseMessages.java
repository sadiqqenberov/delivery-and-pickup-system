...
public enum ErrorResponseMessages implements ResponseMessage {
    ...
    USER_NOT_FOUND("user_not_found_%s", "%s can't find %s", HttpStatus.NOT_FOUND),
    SESSION_NOT_FOUND("Session yoxdur", "Session yoxdur", HttpStatus.NOT_FOUND),
    USER_NOT_AUTHENTICATED("İstifadəçi autentifikasiya olunmayıb","İstifadəçi autentifikasiya olunmayıb",HttpStatus.NOT_FOUND),
